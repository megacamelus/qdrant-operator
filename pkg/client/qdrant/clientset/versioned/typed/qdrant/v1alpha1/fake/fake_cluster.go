...
func (c *FakeClusters) Apply(ctx context.Context, cluster *qdrantv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
...
func (c *FakeClusters) ApplyStatus(ctx context.Context, cluster *qdrantv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
		return nil, fmt.Errorf("cluster provided to Apply must not be nil")
	}
	data, err := json.Marshal(cluster)
