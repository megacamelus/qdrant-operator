...
type ClusterInterface interface {
	...
	Apply(ctx context.Context, cluster *qdrantv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error)
	ApplyStatus(ctx context.Context, cluster *qdrantv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error)
	ClusterExpansion
}
...
func newClusters(c *QdrantV1alpha1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *clusters) Apply(ctx context.Context, cluster *qdrantv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
...
func (c *clusters) ApplyStatus(ctx context.Context, cluster *qdrantv1alpha1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Cluster, err error) {
	if cluster == nil {
		return nil, fmt.Errorf("cluster provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
