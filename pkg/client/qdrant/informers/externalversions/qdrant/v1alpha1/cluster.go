...
import (
	...
	v1alpha1 "github.com/lburgazzoli/qdrant-operator/pkg/client/qdrant/listers/qdrant/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.QdrantV1alpha1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.QdrantV1alpha1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&qdrantv1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&qdrantv1alpha1.Cluster{}, f.defaultInformer)
}
